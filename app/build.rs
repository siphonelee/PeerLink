...
impl WindowsBuild {
    ...
    pub fn check_for_win() {
        ...
        if target.contains("x86_64") {
            println!("cargo:rustc-link-search=native=peerlink/third_party/");
        } else if target.contains("i686") {
            println!("cargo:rustc-link-search=native=peerlink/third_party/i686/");
        } else if target.contains("aarch64") {
            println!("cargo:rustc-link-search=native=peerlink/third_party/arm64/");
        }
