// single-instance server in one machine, every peerlink instance that has ip address and tun device will try create a server instance.
...
// all the clients will exit and let the peerlink instance to launch a new server instance.
