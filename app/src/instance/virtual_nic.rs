...
impl VirtualNic {
    ...
    fn print_troubleshooting_info() {
        ...
        println!("  1. Run with root privileges: sudo ./peerlink-core [options]");
    ...
    async fn create_tun(&mut self) -> Result<tun::platform::Device, Error> {
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            match crate::arch::windows::add_self_to_firewall_allowlist() {
                ...
                Err(e) => {
                    println!("Failed to add PeerLink to firewall allowlist, Subnet proxy and KCP proxy may not work properly. error: {}", e);
